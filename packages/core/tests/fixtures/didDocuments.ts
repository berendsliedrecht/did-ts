                ...
                conditionWeightedThreshold: [
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaaa#active'
                        },
                        weight: 1
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaac#active'
                        },
                        weight: 1
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaaf#active'
                        },
                        weight: 1
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaag#active'
                        },
                        weight: 1
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaah#active'
                        },
                        weight: 1
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaai#active'
                        },
                        weight: 1
                    }
                ],
                ...
                conditionWeightedThreshold: [
                    ...
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaab#active'
                        },
                        weight: 2
                    },
                    {
                    ...
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaad#active'
                        },
                        weight: 2
                    },
                    {
                        condition: {
                            ...
                            type: 'VerifiableCondition',
                            conditionDelegated:
                                'id:eosio:eos::eoscanadaaae#active'
                        },
                        weight: 2
                    },
                    {
