...
export class DidDocument {
    ...
    public findVerificationMethodByDidUrlAndPurpose(
        did: Did | string,
        purpose:
            | 'authentication'
            | 'keyAgreement'
        ...
        const parsedDid = stringOrDid.parse(did)
    ...
    public safeFindVerificationMethodByDidUrlAndPurpose(
        did: Did | string,
        purpose:
            | 'authentication'
            | 'keyAgreement'
    ...
    public toJSON(omitKeys?: Array<string>): Record<string, unknown> {
        ...
        const mappedRest = {
            ...
            assertionMethod: this.assertionMethod?.map(
